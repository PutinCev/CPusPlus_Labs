...
int main()
{
    ...
    // Создание дополнительных студентов (указатели)
    ...
    // Добавление студентов (передаем указатели)
    ...
    // Вывод (сортировка происходит автоматически)
    cout << "В группе " << gr1957.getName() << " " << k << " ст." << endl;
    gr1957.GroupOut();

    // Удаление студента через поиск
